...
<@layout "我的主页">
  ...
  <div class="fly-home fly-panel" style="background-image: url('https://img.1ppt.com/uploads/allimg/2002/1_200228172510_3.JPG');">
      ...
      <#-- ${user.sign!string} !b表示：user.sign为空时，使用string  -->
              ...
              <div class="fly-panel">
                  ...
                  <ul class="jie-row">
                      ...
                      <li>
                          ...
                          <a href="/eblog/post/${post.id}" class="jie-title"> ${post.title}</a>
