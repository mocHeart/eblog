          ...
          <div class="layui-tab-item layui-show">
            <ul class="mine-view jie-row" id="fabu">
              ...
              <script id="tpl-fabu" type="text/html">
                <li>
                  <a class="jie-title" href="/eblog/post/{{d.id}}" target="_blank">{{ d.title }}</a>
                  <i>{{layui.util.toDateString(d.created, 'yyyy-MM-dd HH:mm:ss')}}</i>
                  <a class="mine-edit" href="/eblog/post/edit?id={{d.id}}">编辑</a>
    ...
    layui.use(['laytpl', 'flow', 'util'], function() {
      ...
      flow.load({
        ...
        ,done: function(page, next){
          ...
          $.get('/eblog/user/public?pn='+page, function(res){
      ...
      flow.load({
        ...
        ,done: function(page, next){
          ...
          $.get('/eblog/user/collection?pn='+page, function(res){
            layui.each(res.data.records, function(index, item){
